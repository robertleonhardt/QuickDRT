# QuickDRT
QuickDRT is a lightweight, easy-to-use app for computing distribution of relaxation times (DRT) functions form measured impedance spectra.
...
* Documentation on the underyling DRT algorithm: https://github.com/robertleonhardt/PyDRT
